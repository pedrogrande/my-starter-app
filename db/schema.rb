...
ActiveRecord::Schema.define(version: 20141126085925) do
  ...
  create_table "premium_packages", force: true do |t|
    t.integer  "user_id"
    t.decimal  "price"
  ...
  add_index "premium_packages", ["user_id"], name: "index_premium_packages_on_user_id"
