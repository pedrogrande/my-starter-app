...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { business_id: @testimonial.business_id, review: @testimonial.review, star_rating: @testimonial.star_rating, user_id: @testimonial.user_id }
    end
  ...
  test "should update testimonial" do
    patch :update, id: @testimonial, testimonial: { business_id: @testimonial.business_id, review: @testimonial.review, star_rating: @testimonial.star_rating, user_id: @testimonial.user_id }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
